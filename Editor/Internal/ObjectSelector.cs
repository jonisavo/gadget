...
namespace InspectorEssentials.Editor.Internal
{
    ...
    {
        private static readonly Type ObjectSelectorType =
            typeof(EditorGUI)
                .Assembly
                .GetType("UnityEditor.ObjectSelector");

        private static readonly Func<Object> GetObjectSelector = 
            (Func<Object>) Delegate.CreateDelegate(
        ...
        private static readonly FieldInfo ObjectSelector_objectSelectorID =
